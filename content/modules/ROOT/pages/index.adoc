...
The lab can be accesses through Red Hat Developer Hub, you can login into the assigned Dev Space, a Kubernetes-based Cloud Development Environment, with the credentials printed on the sticker attached to your laptop.
